/**
 * Ensure the n8n "Centro Informativo → TikTok" workflow exists and is active.
 * Uses N8N_API_KEY and N8N_WEBHOOK_URL. Never prints secrets.
 * Run: node scripts/ensure-n8n-centro-tiktok-workflow.mjs
 */
...
const WORKFLOW_JSON_PATH = path.join(repoRoot, "docs/automation/n8n-centro-informativo-tiktok.json");
const TARGET_NAME = "MP26 — Centro Informativo → TikTok";
const EXPECTED_WEBHOOK_PATH = "mp26-centro-informativo-tiktok";
